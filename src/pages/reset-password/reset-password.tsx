...
const ResetPasswordPage = () => {
    ...
    const { resetError, isResetPending } = useAppSelector(store => store.auth)

    const fetchReset = (formData: TFormData) => {
        dispatch(reset({
            formData,
            onSuccess: () => {
    ...
    const { formData, handleChange, handleSubmit } = useFormData<TFormData>({ password: '', token: '' }, fetchReset)
